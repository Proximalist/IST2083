...
```{r}
healthboard <- readxl::read_xlsx((here(dpath, "scottish_health_boards_by_datazone.xlsx")))
glimpse(healthboard)
```
...
```{r}
covid <-readxl::read_xlsx(here(dpath, "covid_total_by_health_board.xlsx"))
covid
```
